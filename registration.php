    ...
    <div class="row">
        <div class="col-md-7 offset-md-3 ">
            <div class="signup-form ">
                <form action="registration.php" method="post" class="mt-5 mb-5  p-5 shadow bg-gradient">
                    ...
                    <div class="mb-3 col-md-12 mt-5">
                        <button class="btn btn-success rounded-pill p-2 col-20"><i>Signup Now</i></button>
                        <hr>
                    </div>
                    <div class="col-md-12">

                        <a href="">
                            <button class=" btn btn-danger col-20  p-2 rounded-pill"><i class="fa fa-google text-light  m-sm-2"></i><span class="text-light align-middle">SignUp with Google</span></button>
                        </a>
                        <hr>
                    </div>
                </form>
