    ...
    <div class="row">
        ...
        <div class= "col-8">
            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner t">
                    <div class="carousel-item active" data-bs-interval="10000">
                        <img src="images/cooking1.jpg" height="550"  class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block bg-gradient">
                            <h5 class="text-yellow"> cooking</h5>
                            <p class="text-yellow">Order to get yummy and delicious dishes prepared for you.</p>
                        </div>
                    </div>
                    <div class="carousel-item" data-bs-interval="2000">
                        <img src="images/outdoorlaundry.jpg" height="550" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block bg-gradient">
                            <h5 class="text-yellow">Outdoor Laundry</h5>
                            <p class="text-yellow">clothes carpets and bedding are taken away for cleaning.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="images/housekeeping.jpg"height="550" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block bg-gradient">
                            <h5 class="text-yellow">House keeping</h5>
                            <p class="text-yellow" >Order to have your household items neatly arranged and tidied up for you </p>
                        </div>
                    </div>
                ...
                <div class="col-4">
                    <div class="card mt-5 bg-purple" >
                        ...
                        <div class="card-body">
                            ...
                            <form action="">
                                <a href="rates.php" ><button class="btn btn-success">get service<</button></a>
            ...
            <div class="row ">
                <div class="col-4">
                    <div class="card mt-5 bg-purple" >
                        <img src="images/electronicrepair1.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Eectronic Repair</p>
                            <a href="rates.php">
                                <button class="btn btn-success">get service</button>
                ...
                <div class="col-4">
                    <div class="card mt-5 bg-purple" >
                        <img src="images/gardening.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Baby sitting</p>
                            <a href="rates.php">
                                <button class="btn btn-success">get service</button>
                ...
                <div class="col-4">
                    <div class="card mt-5 bg-purple" >
                        <img src="images/kidspainting.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Kids fun</p>
                            <a href="rates.php">
                                <button class="btn btn-success">get service</button>
